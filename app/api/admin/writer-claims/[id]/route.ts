...
import { decideClaim } from "@/lib/writerClaims";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

// Admin-only: approve or reject a pending writer claim. Approval inserts the
// writer_editors row and marks the claim decided in one transaction
// (lib/writerClaims.ts decideClaim). Mirrors
// app/api/admin/media-pro-claims/[id]/route.ts.
