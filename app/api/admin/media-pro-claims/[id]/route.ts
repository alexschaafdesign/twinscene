...
import { decideClaim } from "@/lib/mediaProClaims";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

// Admin-only: approve or reject a pending claim. Approval inserts the
// media_pro_editors row and marks the claim decided in one transaction
// (lib/mediaProClaims.ts decideClaim). Mirrors
